...
const UserFormModal: React.FC<UserFormModalProps> = ({ user, onClose, onSave }) => {
  ...
  const handleStaffChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setFormData(prev => ({
      ...prev,
      is_staff: isStaff,
      // Si es administrador, eliminamos los roles asignados
        ...
        <form onSubmit={handleSubmit} className="user-form">
          ...
          <div className="form-group">
            <label htmlFor="password">
              {user ? 'Contraseña (dejar en blanco para mantener la actual)' : 'Contraseña'} {!user && <span className="required">*</span>}
            </label>
            <input
              type="password"
              id="password"
            ...
            <div className="form-group">
              ...
              {groupsLoading ? (
                ...
                <>
                  ...
                  <span className="select-help">Mantén presionado Ctrl (o Cmd en Mac) para seleccionar múltiples roles</span>
                </>
              )}
            </div>
          )}
