...
import { Printer, Download, BarChart2, LineChart as LineChartIcon } from 'lucide-react';
...
const SalesReport: React.FC = () => {
    ...
    const processData = () => {
      ...
      if (filters.service?.serviceId) {
        filteredAppointments = filteredAppointments.filter(appointment => 
          appointment.service === filters.service?.serviceId
        );
      }
  ...
  // src/components/reports/SalesReport.tsx (continuación)
